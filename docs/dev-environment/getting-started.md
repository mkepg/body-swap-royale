...
Optional, for Claude Code workflows:

| Tool | Purpose |
|------|---------|
| **Claude Code** (CLI and/or VS Code extension) | Pair-programming agent — see [`mcp-configuration.md`](mcp-configuration.md) for the Roblox Studio MCP setup |
