...
**Architecture:** Extend `ArenaDescriptor` with a `levels` list so `ArenaDressing` dresses each floor parametrically (stays arena-agnostic). All client-cosmetic. Spec: `docs/specs/2026-06-25-per-floor-dressing-and-banner-design.md`.
