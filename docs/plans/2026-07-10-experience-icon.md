...
**Goal:** Build the complete production kit for the Roblox Experience Icon — tool-agnostic AI prompts, the candidate/final folder structure with workflow docs, and a scripted 512×512 finalizer — per `docs/specs/2026-07-10-experience-icon-design.md`.
