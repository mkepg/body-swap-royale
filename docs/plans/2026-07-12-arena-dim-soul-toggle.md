...
**Goal:** Add `Config.SOUL_HALO_ENABLED` (gate the over-head Soul halo for clean screenshots) and `Config.ARENA_GLOW_DIM` (one arena-agnostic knob softening all decorative Neon), per `docs/specs/2026-07-12-arena-dim-soul-toggle-design.md`.
