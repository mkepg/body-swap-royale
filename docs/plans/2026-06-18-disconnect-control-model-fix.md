...
```markdown
**Status: RESOLVED (2026-06-18).** Implemented via the pure `ControlModel` absorb rule and `ControlManager.removePlayer`; see `docs/plans/2026-06-18-disconnect-control-model-fix.md`. Regression covered by `tests/control_model.spec.luau` (case 2). The notes below are retained as the rationale.
```
