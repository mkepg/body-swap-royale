...
**Tech Stack:** Roblox / Luau, Rojo project (`src/` → game tree), pure modules unit-tested with **lune** (standalone assertion scripts, no TestEZ). Spec: [docs/specs/2026-06-19-swap-legibility-design.md](../specs/2026-06-19-swap-legibility-design.md).
