...
**Related:** builds directly on `docs/superpowers/specs/2026-06-20-round-flow-bookends-design.md` (the Lobby/Results bookends) and the in-round swap HUD (`ClientSwapHud`). GDD §6/§7 (UX/UI, kid-friendly audience: ages 9–16), GUI reference §5 (responsive caps) / §9 (shared theme).
