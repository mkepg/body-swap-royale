...
**Tech Stack:** Luau, Rojo, lune (unit tests for pure modules), Roblox Studio MCP (visual verification + asset sourcing). Spec: `docs/superpowers/specs/2026-06-25-broadcast-world-shell-design.md`. Roadmap: `docs/world-enrichment-roadmap.md`.
