...
**Spec:** `docs/superpowers/specs/2026-07-09-soul-sweeper-v2_4-hitbox-visual-alignment-design.md`
...
```bash
git add src/shared/SweeperModel.luau src/shared/Config.luau src/server/SweeperHazard.luau tests/sweeper_model.spec.luau docs/superpowers/specs/2026-07-09-soul-sweeper-v2_4-hitbox-visual-alignment-design.md docs/superpowers/plans/2026-07-09-soul-sweeper-v2_4-hitbox-visual-alignment.md
