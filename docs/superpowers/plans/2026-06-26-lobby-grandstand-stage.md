...
**Spec:** `docs/superpowers/specs/2026-06-26-lobby-grandstand-stage-design.md`
...
- Hand off to `superpowers:finishing-a-development-branch`: this also flips roadmap Slice 2 to 🟢 and links the plan, then integrates `feat/lobby-grandstand-stage`.
```
