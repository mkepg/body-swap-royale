...
**Tech Stack:** Markdown docs; Windows PowerShell + `System.Drawing` (no working ImageMagick); Git Bash for git. Reference spec: `docs/superpowers/specs/2026-07-12-experience-thumbnails-design.md`.
...
ls docs/superpowers/specs/2026-07-12-experience-thumbnails-design.md scripts/finalize-thumbnail.ps1 2>/dev/null || echo "note: finalize-thumbnail.ps1 comes in Task 4"
```
...
**Files:**
- Modify: `<claude-project-memory>/MEMORY.md`
- Create: `<claude-project-memory>/experience-thumbnails-slice.md`
...
Spec: `docs/superpowers/specs/2026-07-12-experience-thumbnails-design.md`. Same brand family as [[experience-icon-phase-b]].
