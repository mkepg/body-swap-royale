...
**Spec:** `docs/superpowers/specs/2026-07-10-mobile-jump-button-design.md`
...
```bash
git add src/shared/TouchJumpLayout.luau tests/touch_jump_layout.spec.luau src/shared/Config.luau docs/superpowers/specs/2026-07-10-mobile-jump-button-design.md docs/superpowers/plans/2026-07-10-mobile-jump-button.md
