...
| [MCP configuration](dev-environment/mcp-configuration.md) | Roblox Studio MCP setup for Claude Code workflows |
...
`final/` directory. The `candidates/` directories are kept deliberately — they
