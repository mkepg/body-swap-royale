...
This project is built with [Claude Code](https://claude.com/claude-code) on a
deliberately strict loop, and the artifacts are committed rather than thrown
away. Every feature slice gets:

1. A **design spec** in [`docs/superpowers/specs/`](docs/superpowers/specs/) —
   agreed before any code is written (36 of them).
2. An **implementation plan** in [`docs/superpowers/plans/`](docs/superpowers/plans/)
